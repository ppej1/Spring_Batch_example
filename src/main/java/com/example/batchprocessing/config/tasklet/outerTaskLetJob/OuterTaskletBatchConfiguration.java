package com.example.batchprocessing.config.tasklet.outerTaskLetJob;
...
@Configuration
public class OuterTaskletBatchConfiguration {
    private static final Logger log = LoggerFactory.getLogger(OuterTaskletBatchConfiguration.class);
